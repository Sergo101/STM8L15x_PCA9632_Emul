 ...
 102                     ; 114 	slave_address = 0b1100000 & (GPIO_ReadInputDataBit(GPIOA,GPIO_Pin_4)<<1) & GPIO_ReadInputDataBit(GPIOA,GPIO_Pin_5);
 ...
 120                     ; 116 	slave_address = 0b1100000;
 122  002b 35600115      	mov	_slave_address,#96
 123                     ; 117   I2C_DeInit(I2C1);
 125  002f ae5210        	ldw	x,#21008
 126  0032 cd0000        	call	_I2C_DeInit
 128                     ; 120   I2C_Init(I2C1, 100000, slave_address,
 128                     ; 121            I2C_Mode_I2C, I2C_DutyCycle_2,
 128                     ; 122            I2C_Ack_Enable, I2C_AcknowledgedAddress_7bit);
 ...
 146                     ; 126   I2C_ITConfig(I2C1, (I2C_IT_TypeDef)(I2C_IT_ERR | I2C_IT_EVT | I2C_IT_BUF), ENABLE);
 ...
 273                     ; 181 }
 276  0016 81            	ret	
 310                     ; 188 static void TIM1_Config(void)
 310                     ; 189 {
 311                     .text:	section	.text,new
 312  0000               L7_TIM1_Config:
 316                     ; 195   TIM1_TimeBaseInit(TIM1_PRESCALER, TIM1_CounterMode_Up, TIM1_PERIOD, TIM1_REPTETION_COUNTER);
 ...
 326                     ; 198   TIM1_OC1Init(TIM1_OCMode_PWM1, TIM1_OutputState_Enable, TIM1_OutputNState_Disable,
 326                     ; 199                0, TIM1_OCPolarity_High, TIM1_OCNPolarity_Low, TIM1_OCIdleState_Set,
 326                     ; 200                TIM1_OCNIdleState_Set);
 ...
 339                     ; 201   TIM1_OC1PreloadConfig(DISABLE);
 341  0022 4f            	clr	a
 342  0023 cd0000        	call	_TIM1_OC1PreloadConfig
 344                     ; 204   TIM1_OC2Init(TIM1_OCMode_PWM1, TIM1_OutputState_Enable, TIM1_OutputNState_Disable,
 344                     ; 205                0, TIM1_OCPolarity_High, TIM1_OCNPolarity_Low, TIM1_OCIdleState_Set,
 344                     ; 206                TIM1_OCNIdleState_Set);
 ...
 357                     ; 207   TIM1_OC2PreloadConfig(ENABLE);
 359  003a a601          	ld	a,#1
 360  003c cd0000        	call	_TIM1_OC2PreloadConfig
 362                     ; 210   TIM1_OC3Init(TIM1_OCMode_PWM1, TIM1_OutputState_Enable, TIM1_OutputNState_Disable,
 362                     ; 211                0, TIM1_OCPolarity_High, TIM1_OCNPolarity_Low, TIM1_OCIdleState_Set,
 362                     ; 212                TIM1_OCNIdleState_Set);
 ...
 375                     ; 213   TIM1_OC3PreloadConfig(ENABLE);
 377  0053 a601          	ld	a,#1
 378  0055 cd0000        	call	_TIM1_OC3PreloadConfig
 380                     ; 215   TIM1_ARRPreloadConfig(ENABLE);
 382  0058 a601          	ld	a,#1
 383  005a cd0000        	call	_TIM1_ARRPreloadConfig
 385                     ; 218   enableInterrupts();
 388  005d 9a            	rim	
 390                     ; 221   TIM1_CtrlPWMOutputs(ENABLE);
 393  005e a601          	ld	a,#1
 394  0060 cd0000        	call	_TIM1_CtrlPWMOutputs
 396                     ; 223   TIM1_Cmd(ENABLE);
 398  0063 a601          	ld	a,#1
 400                     ; 224 }
 403  0065 cc0000        	jp	_TIM1_Cmd
 433                     ; 226 static void TIM3_Config(void)
 433                     ; 227 {
 434                     .text:	section	.text,new
 435  0000               L11_TIM3_Config:
 439                     ; 233   TIM3_TimeBaseInit(TIM1_PRESCALER, TIM3_CounterMode_Up, TIM1_PERIOD);
 441  0000 ae27d8        	ldw	x,#10200
 442  0003 89            	pushw	x
 443  0004 5f            	clrw	x
 444  0005 cd0000        	call	_TIM3_TimeBaseInit
 446  0008 85            	popw	x
 447                     ; 237   TIM3_OC2Init(TIM3_OCMode_PWM1, TIM3_OutputState_Enable, 0, TIM3_OCPolarity_High, TIM3_OCIdleState_Set);
 ...
 570  0026               L701:
 571                     ; 260 			case AUTO_INCREMENT_OFF: 
 571                     ; 261 				Config_reg[D] = Slave_Buffer_Rx[1];
 ...
 581  0033               L111:
 582                     ; 264 			case AUTO_INCREMENT_ALL:
 582                     ; 265 				for (i = 1; i <= Rx_size; i++){
 584  0033 4c            	inc	a
 585  0034 6b01          	ld	(OFST-1,sp),a
 588  0036 2017          	jra	L151
 589  0038               L541:
 590                     ; 266 					Config_reg[D] = Slave_Buffer_Rx[i];
 ...
 624  0056               L311:
 625                     ; 272 			case AUTO_INCREMENT_BRIGHTNESS:
 625                     ; 273 				for (i = 1; i <= Rx_size; i++){
 627  0056 4c            	inc	a
 628  0057 6b01          	ld	(OFST-1,sp),a
 631  0059 2018          	jra	L361
 632  005b               L751:
 633                     ; 274 					Config_reg[D] = Slave_Buffer_Rx[i];
 ...
 668  007a               L511:
 669                     ; 280 			case AUTO_INCREMENT_GCONTROL:
 669                     ; 281 				for (i = 1; i <= Rx_size; i++){
 671  007a 4c            	inc	a
 672  007b 6b01          	ld	(OFST-1,sp),a
 675  007d 2018          	jra	L571
 676  007f               L171:
 677                     ; 282 					Config_reg[D] = Slave_Buffer_Rx[i];
 ...
 712  009e               L711:
 713                     ; 288 			case AUTO_INCREMENT_I_GCONTROL:
 713                     ; 289 				for (i = 1; i <= Rx_size; i++){
 715  009e 4c            	inc	a
 716  009f 6b01          	ld	(OFST-1,sp),a
 719  00a1 2018          	jra	L702
 720  00a3               L302:
 721                     ; 290 					Config_reg[D] = Slave_Buffer_Rx[i];
 ...
 896                     ; 314 		if ((Config_reg [MODE2] >> 4)&1) {
 ...
 905                     ; 315 			pwm0 = (255 - Config_reg[PWM0]) *40;
 907  0033 4f            	clr	a
 908  0034 97            	ld	xl,a
 909  0035 4a            	dec	a
 ...
 918                     ; 316 			pwm1 = (255 - Config_reg[PWM1]) *40;
 920  0041 4f            	clr	a
 921  0042 97            	ld	xl,a
 922  0043 4a            	dec	a
 ...
 931                     ; 317 			pwm2 = (255 - Config_reg[PWM2]) *40;
 933  004f 4f            	clr	a
 934  0050 97            	ld	xl,a
 935  0051 4a            	dec	a
 ...
 944                     ; 318 			pwm3 = (255 - Config_reg[PWM3]) *40;
 946  005d 4f            	clr	a
 947  005e 97            	ld	xl,a
 948  005f 4a            	dec	a
 ...
 997                     ; 331 				Set_LED0 (0);
 999  009a 5f            	clrw	x
1001                     ; 332 				en_blink_led0 = 0;
1002                     ; 333 				break;
1004  009b 2007          	jp	LC002
1005  009d               L712:
1006                     ; 334 			case 0b01:
1006                     ; 335 				Set_LED0 (10200);
1008  009d ae27d8        	ldw	x,#10200
1010                     ; 336 				en_blink_led0 = 0;
1011                     ; 337 				break;
1013  00a0 2002          	jp	LC002
1014  00a2               L122:
1015                     ; 338 			case 0b10:
1015                     ; 339 				Set_LED0 (pwm0);
1017  00a2 1e05          	ldw	x,(OFST-7,sp)
1019                     ; 340 				en_blink_led0 = 0;
1021  00a4               LC002:
...
1055                     ; 350 				Set_LED1 (0);
1057  00c5 5f            	clrw	x
1059                     ; 351 				en_blink_led1 = 0;
1060                     ; 352 				break;
1062  00c6 2007          	jp	LC003
1063  00c8               L722:
1064                     ; 353 			case 0b01:
1064                     ; 354 				Set_LED1 (10200);
1066  00c8 ae27d8        	ldw	x,#10200
1068                     ; 355 				en_blink_led1 = 0;
1069                     ; 356 				break;
1071  00cb 2002          	jp	LC003
1072  00cd               L132:
1073                     ; 357 			case 0b10:
1073                     ; 358 				Set_LED1 (pwm1);
1075  00cd 1e07          	ldw	x,(OFST-5,sp)
1077                     ; 359 				en_blink_led1 = 0;
1079  00cf               LC003:
...
1113                     ; 369 				Set_LED2 (0);
1115  00f0 5f            	clrw	x
1117                     ; 370 				en_blink_led2 = 0;
1118                     ; 371 				break;
1120  00f1 2007          	jp	LC004
1121  00f3               L732:
1122                     ; 372 			case 0b01:
1122                     ; 373 				Set_LED2 (10200);
1124  00f3 ae27d8        	ldw	x,#10200
1126                     ; 374 				en_blink_led2 = 0;
1127                     ; 375 				break;
1129  00f6 2002          	jp	LC004
1130  00f8               L142:
1131                     ; 376 			case 0b10:
1131                     ; 377 				Set_LED2 (pwm2);
1133  00f8 1e09          	ldw	x,(OFST-3,sp)
1135                     ; 378 				en_blink_led2 = 0;
1137  00fa               LC004:
